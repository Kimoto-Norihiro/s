...
func main() {
	...
	r.POST("/journals", jh.ListJournals)
	...
	r.POST("/international_conferences", ich.ListInternationalConferences)
	...
	r.POST("/domestic_conferences", dch.ListDomesticConferences)
